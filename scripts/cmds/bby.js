...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("bbz") || body.startsWith("babu") || body.startsWith("jns") || body.startsWith("faiza") || body.startsWith("kuttu")) {
    ...
    "Amake vhule jao 🥺",
    "Ami shudhu Arafat er. Don't disturb me! 🤦",
    ...
    "আমার বস Arafat রে ডাক ওই সিঙ্গেল আছে 🐸🫦",
